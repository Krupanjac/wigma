...
/** SectionTool — click+drag to create section containers. */
export class SectionTool extends BaseTool {
  readonly type: ToolType = 'section';
  readonly label = 'Section';
  readonly icon = 'section';
  ...
  override onPointerDown(event: PointerEventData): void {
    ...
    this.currentNode = new RectangleNode('Section');
    this.currentNode.fill = { color: hexToColor('#0f172a20'), visible: true };
    this.currentNode.stroke = { color: hexToColor('#64748b'), width: 1, visible: true };
